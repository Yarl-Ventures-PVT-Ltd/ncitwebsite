    ...
    <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-ncit-ink text-white relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Membership Designed to Create Real Opportunity.
          </motion.h1>
          ...
          >
            NCIT membership combines credibility, connections, industry voice, knowledge, opportunities and practical support - with benefits tailored to each membership category.
          </motion.p>
          ...
          >
            <a href="#matrix" className="w-full sm:w-auto inline-flex items-center justify-center bg-ncit-blue text-white hover:bg-blue-600 px-8 py-4 text-base font-medium rounded-xl shadow-md transition-all">
              Compare Plans
            </a>
